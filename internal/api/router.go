...
func (a *App) Router(server vserver.Server) vserver.Server {
	...
	e.Add(http.MethodGet, "/api/v1/admin/apps/:appKey/accounts/:accountId/grants", auth.RequireAdmin("admin:grant:read")(h.AdminListGrants))
	...
	e.Add(http.MethodGet, "/api/v1/admin/apps/:appKey/invitations", auth.RequireAdmin("admin:invitation:read")(h.AdminListInvitations))
	...
	e.Add(http.MethodGet, "/api/v1/admin/apps/:appKey/resources", auth.RequireAdmin("admin:resource:read")(h.AdminResourceTree))
	...
	e.Add(http.MethodGet, "/api/v1/admin/apps/:appKey/roles/:roleId/resources", auth.RequireAdmin("admin:role:read")(h.AdminListRoleResources))
